...
**Waitress at the Bluebird Diner** — the most powerful character who never appears on screen.
...
**The design insight:** Juanita is the most radical character in either show folder — a **CHARACTER.yml with no room presence**. She has a data file. She has relationships. She has a location (the Bluebird Diner). But she never physically appears in any room. She exists only as a reference in other characters' relationship maps and as an advertisement on the diner's phone. In MOOLLM terms, she's a **phantom node** — fully modeled, never rendered. The system knows she's there. The world never shows her. And that's exactly what makes her effective.
